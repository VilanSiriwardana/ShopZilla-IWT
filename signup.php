...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        header("Location: seller_profile.php?S_ID=$S_ID");
        exit();
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">             <!--form started-->
            <div class="mb-3">
           ...
           Terms and Conditions:
            ...
            <input type="submit" name="submit" class="sign_up" value="Sign Up" onclick="return validateForm();">                   <!--sign up button-->
        </form><br>        <!--form ended-->

        <h4>Already a user? <a href="login.php" target="_blank"> Login </a></h4>             <!--login link-->
    </div>

    <?php include("footer.php") ?>                        <!--footer file-->

    <!-- JavaScript code to display the message related to agree checkbox -->
    <script>                                        
